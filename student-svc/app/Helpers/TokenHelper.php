...
class TokenHelper
{
    ...
    public function __construct(int $tokenValidity = 360, string $issuer = "student-svc")
    {
    ...
    public static function create(int $tokenValidity = 360, string $issuer = "student-svc") : self
    {
